...
au BufWinEnter,BufFilePost .msmtprc,*/.config/msmtp/config call s:keywordprg('msmtp')
au BufWinEnter,BufFilePost .latexmkrc,*/.config/latexmkrc                 call s:keywordprg('latexmk')
au BufWinEnter,BufFilePost NetworkManager.conf        call s:keywordprg('NetworkManager.conf')
au BufWinEnter,BufFilePost .tigrc,*/.config/tig*      call s:keywordprg('tigrc')
